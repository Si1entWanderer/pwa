...
return new Promise((resolve, reject) => {
  //execute command 
 exec(enwebp(),query.split(/\s+/),{encoding: 'ISO-8859-15', maxBuffer: 1024*1024*100}, (error, stdout, stderr) => {
  if (error) {
   console.warn(error);
  }
...
return new Promise((resolve, reject) => {
  //execute command 
 exec(dewebp(),query.split(/\s+/), {encoding: 'ISO-8859-15', maxBuffer: 1024*1024*100 }, (error, stdout, stderr) => {
  if (error) {
   console.warn(error);
  }
  resolve(stdout? stdout : stderr);
...
return new Promise((resolve, reject) => {
  //execute command 
 exec(gifwebp(),query.split(/\s+/),{encoding: 'ISO-8859-15', maxBuffer: 1024*1024*100 }, (error, stdout, stderr) => {
  if (error) {
   console.warn(error);
  }
  resolve(stdout? stdout : stderr);
